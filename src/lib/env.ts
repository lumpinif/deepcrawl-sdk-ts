...
export interface Env {
  DEEPCRAWLAPP_BEARER?: string | undefined;

  DEEPCRAWLAPP_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  DEEPCRAWLAPP_BEARER: z.string().optional(),

  DEEPCRAWLAPP_DEBUG: z.coerce.boolean().optional(),
});
