...
import { DeepcrawlAppDefaultError } from "../models/errors/deepcrawlappdefaulterror.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | DeepcrawlAppDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<T, E | DeepcrawlAppDefaultError | ResponseValidationError>,
      raw: unknown,
    ]
  > {
    let raw: unknown;
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new DeepcrawlAppDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new DeepcrawlAppDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
